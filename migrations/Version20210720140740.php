 ...
 */
final class Version20210720140740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction ALTER pay_time DROP NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE transaction ALTER created_at TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE transaction ALTER created_at DROP DEFAULT');
        $this->addSql('ALTER TABLE transaction ALTER pay_time SET NOT NULL');
